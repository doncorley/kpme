...
public class TaxRateLookupableHelper extends KPMELookupableHelper {
    ...
    public List<? extends BusinessObject> getSearchResults(Map<String, String> fieldValues) {
        ...
        return HrServiceLocator.getTaxRateService().getTaxRates(GlobalVariables.getUserSession().getPrincipalId(), dept, location, descr, active, showHist);
    }
}