...
public class TaxRatePrincipalRoleMemberBo extends PrincipalRoleMemberBo {

	private static final long serialVersionUID = 6571029461890035997L;
	private static final Logger LOG = Logger.getLogger(TaxRatePrincipalRoleMemberBo.class);

	public static TaxRatePrincipalRoleMemberBo from(RoleMemberBo roleMemberBo, Map<String, String> attributes) {
        if (roleMemberBo == null) { 
        	return null;
        }

        TaxRatePrincipalRoleMemberBo.Builder b = new TaxRatePrincipalRoleMemberBo.Builder(roleMemberBo.getRoleId(), roleMemberBo.getMemberId(), roleMemberBo.getType());
	...
	public TaxRatePrincipalRoleMemberBo() {
		super();
	}
	
    private TaxRatePrincipalRoleMemberBo(Builder b) {
        setId(b.getId());
	...
	public static final class Builder implements ModelBuilder, ModelObjectComplete {
        ...
        @Override
        public TaxRatePrincipalRoleMemberBo build() {
            return new TaxRatePrincipalRoleMemberBo(this);
        }
