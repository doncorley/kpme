 ...
 */
package org.kuali.kpme.core.taxrate.authorization;
...
public class TaxRateAuthorizer extends KPMEMaintenanceDocumentAuthorizerBase {
	...
	protected void addRoleQualification(Object dataObject, Map<String, String> attributes) {
		...
		if (dataObject instanceof TaxRate) {
		...
		attributes.put(KPMERoleMemberAttribute.TAX_RATE.getRoleMemberAttributeName(), department);
